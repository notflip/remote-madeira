      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xl-8">
            <div className="cta-content-box text-center text-white">
              <h2 className="mb-35">{ctaTitle}</h2>
              <Link
                href={`https://wa.me/${settings.settings.phone.replace(/[^\d]/g, '')}`}
                className="inline-flex gap-2 items-center px-4 py-2 rounded-lg text-white bg-[#25D366]"
              >
                <svg
