        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {aboutItems &&
            aboutItems.map((item, index) => {
              ...
              const columnSpan = isFirstItem ? 'lg:col-span-2' : ''
              const aspectRatio = isFirstItem
                ? 'relative aspect-[2/2] lg:aspect-[16/9]'
                : 'relative aspect-[2/2] lg:aspect-[2/2.5]'
